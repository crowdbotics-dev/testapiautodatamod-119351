...
## Project Structure
    ...
    ├── testapiautodatamod_119351  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_119351`
...
2. Clone this repo and `cd testapiautodatamod_119351`
